<section class="intro agent">
	<div class="container"> 
		...
		<div class="intro__img wow fadeInUp">
			<picture>
				<source srcset="<?php echo esc_url( get_template_directory_uri() ); ?>/img/agent-img.webp" type="image/webp">
				<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/agent-img.png" alt="">
			</picture>
		</div>
	</div>
</section>